...
requirements = setuptools<70, cython>=3.1.0, python3, kivy==2.3.1, pillow==9.0.0, materialyoucolor, exceptiongroup, https://github.com/matham/ffpyplayer/archive/v4.5.2.zip, asyncgui, asynckivy, https://github.com/kivymd/KivyMD/archive/master.zip
