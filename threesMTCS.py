    ...
    def get_reward(env,state):
        ...
        for i in range(0,2):
            ...
            if i == 1:
                Bot_Hand = Hand
        reward = 0
        difference = 10 * (len(Hand) - len(Bot_Hand))
        card_value = math.log10(sum([rank_order[card[0]] for card in Bot_Hand]))
        if len(Bot_Hand) < 3:
            reward += 5
...
state = {'name': 'threes', 'deck': ['AD', '2D', '3D', '4D', '5D', '6D', '7D', '8D', '9D', '1D', 'JD', 'QD', 'KD', 'AS', '2S', '3S', '4S', '5S', '6S', '7S', '8S', '9S', '1S', 'JS', 'QS', 'KS', 'AC', '2C', '3C', '4C', '5C', '6C', '7C', '8C', '9C', '1C', 'JC', 'QC', 'KC', 'AH', '2H', '3H', '4H', '5H', '6H', '7H', '8H', '9H', '1H', 'JH', 'QH', 'KH'], 'shuffled_deck': ['KH', '7D', 'AS', 'AC', '9C', 'QC', '8C', 'QS', '1S', '4S', '1C', 'KS', '2D', '3C', '8H', '3S', '9S', 'JD', '5D', 'QH', '7C', 'QD', '5H', 'AD', '8D', '5C', '6H', '6D', '4H', '1H', '2S', '7S', '3D'], 'rank_order': {'A': 14, 'K': 13, 'Q': 12, 'J': 11, '1': 16, '9': 9, '8': 8, '7': 7, '6': 6, '5': 5, '4': 4, '3': 3, '2': 15}, 'hands': [['4D', '5S', '1D'], ['3H', '9H', '2H']], 'discard_pile': [], 'selected_card': '', 'turn': 0, 'time_elapsed': 0, 'difficulty': (0, 'Easy'), 'winner': None, 'bottom_hands': [['9D', '6C', 'JH'], ['KC', '6S', 'JC']], 'top_hands': [['KD', 'AH', '8S'], ['JS', '2C', '4C']], 'another': False, 'played_cards': ['3H', '4D', '7H'], 'history': [(0, '3H', 'play'), (1, '4D', 'play'), (0, '7H', 'play')]}
...
print(one_level_mtcs(state,genv,20))